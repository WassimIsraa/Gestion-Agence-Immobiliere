...
import objet.ContratVente	;


public class ContratVenteDAO {
	
	Session session;
	SessionFactory sf;

	public ContratVenteDAO()
	{
		sf=new AnnotationConfiguration().configure().buildSessionFactory();
		session=sf.openSession();
	}
	public void save(ContratVente a)
	{
		Transaction tr1=session.beginTransaction();
		session.save(a);
		tr1.commit();
	}
	public void update(ContratVente a)
	{
		Transaction tr2=session.beginTransaction();
		session.update(a);
		tr2.commit();
	}
	public void delete(ContratVente a)
	{
