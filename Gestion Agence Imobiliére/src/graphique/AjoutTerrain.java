...
public class AjoutTerrain extends JFrame {
	...
	public AjoutTerrain() {
		...
		JLabel lblAjouterUnAppartement = new JLabel("Ajouter un terrain");
		lblAjouterUnAppartement.setIcon(new ImageIcon(AjoutTerrain.class.getResource("/Images/logo-terrain.jpg")));
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(50)
							.addComponent(description, GroupLayout.PREFERRED_SIZE, 81, GroupLayout.PREFERRED_SIZE)
